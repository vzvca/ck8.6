...
TCL_VERSION =		
TCL_DIR =		/home/t0107322/CTK/ck8.6
TCL_INCLUDE_SPEC =	

# The directory containing the Tcl library archive file appropriate
# for this version:
TCL_BIN_DIR =		/home/t0107322/CTK/ck8.6
...
# via /usr/include).
CURSES_INCLUDES = -I/usr/include/ncursesw -D_XOPEN_SOURCE_EXTENDED -DUSE_NCURSES -DUSE_NCURSESW

# Linker switch(es) to use to link with the curses library archive (the
# configure script will try to set this value automatically, but you
# can override it).
CURSES_LIB_SWITCHES =	-lncursesw
...
LIBS = -L/home/t0107322/CTK/ck8.6 -ltcl  $(CURSES_LIB_SWITCHES)   -lc
...
AC_FLAGS =		 -DHAVE_UNISTD_H=1 -DHAVE_LIMITS_H=1 -DSTDC_HEADERS=1 -DRETSIGTYPE=void -DHAVE_SIGACTION=1 -DHAVE_SCR_DUMP=1 -DTK_FILE_COUNT=_r 
...
WIDGOBJS = ckButton.o ckEntry.o ckFrame.o ckListbox.o \
	ckMenu.o ckMenubutton.o ckMessage.o ckScrollbar.o ckTree.o ckTerminal.o \
	ckProgress.o ckPlaycard.o
...
SRCS = ckBind.c ckBorder.c ckCmds.c ckConfig.c ckEvent.c ckFocus.c \
	...
	ckMenu.c ckMenubutton.c ckMessage.c ckScrollbar.c \
	ckText.c ckTextBTree.c ckTextDisp.c ckTextIndex.c \
	ckTextMark.c ckTextTag.c ckTree.c ckTerminal.c ckProgress.c ckPlaycard.c \
	ckAppInit.c
...
cwsh: ckAppInit.o $(CK_LIB_FILE)
	$(CC) $(LD_FLAGS) ckAppInit.o -L/home/t0107322/CTK/ck8.6 -lck $(LIBS) -o cwsh
...
configInfo: Makefile
	...
	@echo "CK_LIBS = ${CURSES_LIB_SWITCHES} " >> configInfo
