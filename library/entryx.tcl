...
bind EntryInteger  <ASCIIDelete> {ckEntryXBackspace %W}
bind EntryUnsigned <ASCIIDelete> {ckEntryXBackspace %W}
bind EntryFloat    <ASCIIDelete> {ckEntryXBackspace %W}
bind EntryRegexp   <ASCIIDelete> {ckEntryXBackspace %W}
bind EntryNormal   <ASCIIDelete> {ckEntryXBackspace %W}
